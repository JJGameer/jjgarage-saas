      ...
      <div class="email-container">
        ...
        <div class="email-content">
          ...
          <table align="center" style="margin-top: 10px;">
            <tr>
              <td>
                <a href="https://jjgarage.pt/register?codigo=${codigo}" class="email-button">Completar Registo</a>
              </td>
            </tr>
          </table>
    ...
    <body>
      <div class="email-container">
        ...
        <div class="email-content">
          ...
          <a href="https://jjgarage.pt/login" class="email-button">Aceder ao JJGarage</a>
    ...
    <body>
      <div class="email-container">
        ...
        <div class="email-content">
          ...
          <a href="${resetLink}" class="email-button" style="color: #ffffff !important;">Redefinir Palavra-passe</a>
...
const emailSuspensao = (nomeOficina) => `
  ...
  <html>
    ...
    <body>
      <div class="email-container">
        <div class="email-header" style="background: linear-gradient(135deg, #1a1a1a 0%, #e74c3c 100%);">
        ...
        <div class="email-content">
          ...
          <a href="https://whop.com" class="email-button">Regularizar Pagamento</a>
