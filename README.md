...
* **Recuperação de Password Autónoma:** Sistema de redefinição de credenciais via e-mail utilizando **Nodemailer**. Gera tokens criptografados com expiração e validação de estado diretamente na base de dados.
