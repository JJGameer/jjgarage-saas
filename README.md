...
Recuperação de Password Autónoma: Sistema de redefinição de credenciais via e-mail utilizando Nodemailer. Gera tokens criptografados com expiração de 1 hora e validação de estado diretamente na base de dados.
...
Serviço de Email: Nodemailer (Envio de templates e recuperação de conta)
